...
export const AnimalParams = Type.Object({
  animal_id: Type.String({
    ...
    examples: [
      ...
      "b3c54c16-7538-4984-a332-463fc2ea3d47",
      "07e9cb7a-59e5-4d3f-8c5b-91715b86d87e",
...
export const Animal = Type.Object(
  {
    ...
    breed: Type.String({
      examples: ["Hereford", "Aberdeen Angus", "Holando", "Braford"],
    }),
    birth_date: Type.String({
      format: "date",
      examples: ["2021-03-15", "2020-08-22"],
    }),
...
export const AnimalFilter = Type.Object(
  {
    breed: Type.Optional(
      Type.String({
        minLength: 1,
        examples: ["Hereford", "Aberdeen Angus", "Holando"],
      })
    ),
...
export const AnimalPost = Type.Object(
  {
    ...
    birth_date: Type.String({
      format: "date",
      examples: ["2021-03-15", "2020-08-22", "2022-01-05"],
    }),
    owner_id: Type.String({
      format: "uuid",
      examples: [
...
export const AnimalHistorySchema = Type.Object(
  {
    id: Type.String({
      ...
      examples: [
        "1bf92745-ffe6-43b8-94ba-57c12dbde3b5",
        "32bebf98-399e-4e59-ba53-ea7fbcf8a49f",
      ],
    }),
    animal_id: Type.String({
      format: "uuid",
...
export const AnimalWithTag = Type.Object({
  ...
  breed: Type.String({ examples: ["Abigar", "Hereford", "Aberdeen Angus"] }),
  birth_date: Type.String({ format: "date", examples: ["2020-01-01", "2021-05-12", "2022-03-23"] }),
  owner_id: Type.String({
    format: "uuid",
    examples: ["56b33cc3-6e43-4aac-99cf-a90bc681d583", "de3d6619-7d68-45a6-80df-2d464b6716d4"],
  }),
  land_id: Type.String({
    format: "uuid",
    examples: ["ca751bd3-3df5-4967-8282-252ac89543ba", "43666c09-a0b0-4b6b-9558-e44b50a25d57"],
  }),
  status: Type.Union(
    [
      Type.Literal("alive"),
  ...
  created_at: Type.String({
    format: "date-time",
    examples: ["2020-01-01T00:00:00Z", "2021-05-12T08:30:00Z"],
  }),
  updated_at: Type.String({ 
    format: "date-time",
    examples: ["2023-06-15T10:45:00Z", "2023-09-20T14:30:00Z"] 
  }),
  //current_tag: Type.Object(AnimalTagInfo),
}, {
  examples: [
    {
      id: "0a553254-e85c-4780-8995-34098a788256",
      breed: "Abigar",
      birth_date: "2020-01-01",
      owner_id: "56b33cc3-6e43-4aac-99cf-a90bc681d583",
      land_id: "ca751bd3-3df5-4967-8282-252ac89543ba",
      status: "alive",
      created_at: "2020-01-01T00:00:00Z",
      updated_at: "2023-06-15T10:45:00Z"
    },
    {
      id: "c42f9084-3356-48f2-a7b1-f05bd8524cc2",
      breed: "Hereford",
      birth_date: "2021-05-12",
      owner_id: "de3d6619-7d68-45a6-80df-2d464b6716d4",
      land_id: "43666c09-a0b0-4b6b-9558-e44b50a25d57",
      status: "alive",
      created_at: "2021-05-12T08:30:00Z",
  ...
  Type.Object({
    ...
    modified_by_email: Type.Optional(
      Type.String({ 
        ...
        examples: ["ganadero1@outlook.com", "operador@mgap.gub.uy"]
      })
    ),
  }),
], {
  examples: [
    {
      ...
      modified_by: "de3d6619-7d68-45a6-80df-2d464b6716d4",
      modification_date: "2023-09-15T10:00:00Z",
      modified_by_id: "de3d6619-7d68-45a6-80df-2d464b6716d4",
      modified_by_email: "ganadero1@outlook.com"
    },
    {
      id: "32bebf98-399e-4e59-ba53-ea7fbcf8a49f",
      animal_id: "7eb4d619-6c02-4f02-ab7a-3e302a74eff6",
      ...
      modified_by: "100dc01b-7225-4893-b853-0c9bf1804bc4",
      modification_date: "2023-08-20T14:30:00Z",
      modified_by_id: "100dc01b-7225-4893-b853-0c9bf1804bc4",
      modified_by_email: "operador@mgap.gub.uy"
    }
  ]
});
...
export const AnimalMovementWithLandsSchema = Type.Intersect([
  ...
  Type.Object({
    ...
    destiny_latitude: Type.String({
      description: "Latitude of destination land",
    }),
    destiny_longitude: Type.String({
      description: "Longitude of destination land",
    }),
  }),
], {
  examples: [
    {
      ...
      date: "2023-09-15T08:30:00Z",
      details: "Transporte para cambio de potrero",
      origin_land_name: "Estancia San José",
      origin_latitude: "-34.478611",
      origin_longitude: "-56.892778",
      destiny_land_name: "Predio La Esperanza",
      destiny_latitude: "-33.245667",
      destiny_longitude: "-57.123456"
    },
    {
      id: "e1f050fc-7f84-4efa-abd6-468de4cb5e0e",
      animal_id: "7eb4d619-6c02-4f02-ab7a-3e302a74eff6",
      ...
      date: "2023-09-18T10:15:00Z",
      details: "Movimiento por sequía",
      origin_land_name: "Predio La Esperanza",
      origin_latitude: "-33.245667",
      origin_longitude: "-57.123456",
      destiny_land_name: "Campo La Verde",
      destiny_latitude: "-32.512345",
      destiny_longitude: "-55.987654"
    }
  ]
});

export type AnimalMovementWithLands = Static<
  typeof AnimalMovementWithLandsSchema
>;
