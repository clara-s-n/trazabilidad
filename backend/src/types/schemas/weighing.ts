...
export const WeighingParams = Type.Object({
  weighing_id: Type.String({ 
    format: 'uuid',
    examples: ["241f0df3-3d21-4a7f-b0f4-83d3136dd455", "da7bb15f-92f6-4739-9420-5685e45c7caa"]
  }),
});
...
export const CreateWeighingBody = Type.Object({
  ...
  comments: Type.Optional(Type.String({ 
    minLength: 1,
    examples: ["Pesaje mensual rutinario", "Pesaje pre-vacunación", "Control de crecimiento"]
  }))
}, {
  examples: [
    {
