...
INSERT INTO users (id, email, password_hash, role_id, created_at) VALUES
  ('de3d6619-7d68-45a6-80df-2d464b6716d4', 'user1@example.com', crypt('pass1', gen_salt('bf')), 2, now()),
  ('100dc01b-7225-4893-b853-0c9bf1804bc4', 'user2@example.com', crypt('pass2', gen_salt('bf')), 3, now()),
  ('26b12297-942a-451e-95bf-2d98f915c636', 'user3@example.com', crypt('pass3', gen_salt('bf')), 1, now()),
